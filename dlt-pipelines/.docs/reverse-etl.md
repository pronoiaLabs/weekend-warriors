...
| Supported loader file formats | typed-jsonl, parquet | [File formats](../file-formats/) |
...
*This table shows the supported features of the Destination destination in dlt.*
