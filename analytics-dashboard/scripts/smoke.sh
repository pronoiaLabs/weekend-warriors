...
ROUTES=(
  ...
  "/nfl/games/$GAME_KEY|Back to the slate"
  "/nfl/games/$GAME_KEY/props|Pinned plays"
  "/nfl/games/$GAME_KEY/props?vendor=fanduel|Spread, fanduel"
  "/nfl/games/$GAME_KEY/situations|Situations"
  "/nfl/games/$GAME_KEY/lines|Snapshots at"
  ...
  "/nfl/players|Cast wide, filter down"
  "/nfl/players?season=2025&season_type=Regular%20Season|Risers"
  "/nfl/players?season=2025&season_type=Regular%20Season&position=WR&sort=rank_receptions|Jaxon Smith-Njigba"
  "/nfl/players/daca41214b39c5dc66674d09081940f0?season=2025&season_type=Regular%20Season|Where the work comes from"
  "/nfl/players/nope|No such player"
  "/nfl/plays|Anchor the feed"
  "/nfl/plays?team=KC&season=2025&week=18|Play feed"
  "/nfl/plays?player_key=daca41214b39c5dc66674d09081940f0&season=2025|pinned"
  ...
  "/nfl/explore|Export CSV"
  "/nfl/explore?sheet=plays&where=season:2025|One row per play"
